...
function makeZoneSchoolsChart(dataObjectsArray) {
    ...
    // data: School, schoolCode, schoolType, schoolLevel, schoolExpenditure, schoolSqft, schoolLng, schoolLat, schoolWard
    // nextSchoolObject = { School: null, schoolExpenditure: null }
